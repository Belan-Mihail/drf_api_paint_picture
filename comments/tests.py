...
class CommentListViewTests(APITestCase):
    ...
    def setUp(self):
        ...
        picture1_comment = Comment.objects.create(
             owner=user, picture_id=1, content='comment1'
        )
        picture1_comment2 = Comment.objects.create(
            owner=user, picture_id=1, content='comment2'
        )
    ...
    def test_logged_in_user_can_create_comment(self):
        ...
        response = self.client.post(
            '/comments/', {'picture': 1, 'content': 'comment3'}
        )
        count = Comment.objects.count()
    ...
    def test_user_not_logged_in_cant_create_comment(self):
        response = self.client.post(
            '/comments/', {'picture': 1, 'content': 'comment4'}
        )
...
class CommentDetailViewTests(APITestCase):
    ...
    def setUp(self):
        ...
        picture1_comment = Comment.objects.create(
            owner=user1, picture_id=1, content='comment1'
        )
        picture1_comment2 = Comment.objects.create(
            owner=user2, picture_id=1, content='comment2'
        )
    ...
    def test_user_can_update_own_comment(self):
        ...
        response = self.client.put(
            '/comments/1/', {'content': 'a new content'}
        )
    ...
    def test_user_cant_update_not_own_comment(self):
        self.client.login(username='user1', password='pass')
        response = self.client.put(
            '/comments/2/', {'content': 'a new content'}
        )
